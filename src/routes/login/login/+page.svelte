...
<body class="bg-white fixed h-screen w-full">
    ...
    <div 
        ...
        <!-- title/tagline/terms -->
        <div class="flex flex-col space-y-2 justify-center mx-auto items-center mb-6 text-center">
            <h1 class="text-lime-400 text-lg leading-6">Login to<br>BURRITOSLUT</h1>
            <p class="text-sm text-center text-black my-1">New to BurritoSlut? <a href="/signup">Sign up</a></p>
